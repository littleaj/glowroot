...
public class JavaLoggingIT {
    ...
    public void testLog() throws Exception {
        ...
        assertThat(entry.getMessage())
                .isEqualTo("log info: o.g.i.logger.JavaLoggingIT$ShouldLog - cde");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warning: o.g.i.logger.JavaLoggingIT$ShouldLog - def");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log severe: o.g.i.logger.JavaLoggingIT$ShouldLog - efg");
    ...
    public void testLogWithThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log info: o.g.i.l.JavaLoggingIT$ShouldLogWithThrowable - cde_");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warning: o.g.i.l.JavaLoggingIT$ShouldLogWithThrowable - def_");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log severe: o.g.i.l.JavaLoggingIT$ShouldLogWithThrowable - efg_");
    ...
    public void testLogWithNullThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log info: o.g.i.l.JavaLoggingIT$ShouldLogWithNullThrowable - cde_");
        ...
        assertThat(entry.getMessage())
                .isEqualTo(
                        "log warning: o.g.i.l.JavaLoggingIT$ShouldLogWithNullThrowable - def_");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log severe: o.g.i.l.JavaLoggingIT$ShouldLogWithNullThrowable - efg_");
    ...
    public void testLogWithLogRecord() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warning: o.g.i.l.JavaLoggingIT$ShouldLogWithLogRecord - def__");
    ...
    public void testLogWithPriority() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log info: o.g.i.l.JavaLoggingIT$ShouldLogWithPriority - cde__");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warning: o.g.i.l.JavaLoggingIT$ShouldLogWithPriority - def__");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log severe: o.g.i.l.JavaLoggingIT$ShouldLogWithPriority - efg__");
    ...
    public void testLogWithPriorityAndThrowable() throws Exception {
        ...
        assertThat(entry.getMessage()).isEqualTo(
                "log info: o.g.i.l.JavaLoggingIT$ShouldLogWithPriorityAndThrowable - cde___");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warning: o.g.i.l.JavaLoggingIT$ShouldLogWithPriorityAndThrowable - def___");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log severe: o.g.i.l.JavaLoggingIT$ShouldLogWithPriorityAndThrowable - efg___");
    ...
    public void testLogWithPriorityAndNullThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log info: o.g.i.l.JavaLoggingIT$ShouldLogWithPriorityAndNullThrowable"
                        + " - cde___null");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warning: o.g.i.l.JavaLoggingIT$ShouldLogWithPriorityAndNullThrowable"
                        + " - def___null");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log severe: o.g.i.l.JavaLoggingIT$ShouldLogWithPriorityAndNullThrowable"
                        + " - efg___null");
    ...
    public void testLogWithParameters() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log info: o.g.i.l.JavaLoggingIT$ShouldLogWithParameters - efg_56_67");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo(
                        "log warning: o.g.i.l.JavaLoggingIT$ShouldLogWithParameters - fgh_67_78");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo(
                        "log severe: o.g.i.l.JavaLoggingIT$ShouldLogWithParameters - ghi_78_89");
    ...
    public void testLocalizedLogWithParameters() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log info: o.g.i.l.JavaLoggingIT$ShouldLocalizedLogWithParameters"
                        + " - abc_56_67");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warning: o.g.i.l.JavaLoggingIT$ShouldLocalizedLogWithParameters"
                        + " - xyz_78_67");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log severe: o.g.i.l.JavaLoggingIT$ShouldLocalizedLogWithParameters"
                        + " - abc_78_89");
