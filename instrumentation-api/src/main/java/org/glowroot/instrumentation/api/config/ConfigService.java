...
public interface ConfigService {
     ...
     * are changed.
     * 
     * This allows the useful instrumentation optimization of caching the results of
     ...
     * META-INF/glowroot.instrumentation.json file, and can be modified (assuming they are not
