 ...
 */
package org.glowroot.engine.init;
...
public class PreInitializeWeavingClasses {
    ...
    private static List<String> getGlowrootUsedTypes() {
        List<String> types = Lists.newArrayList();
        types.add("org.glowroot.engine.bytecode.api.Bytecode");
        types.add("org.glowroot.engine.bytecode.api.BytecodeService");
        types.add("org.glowroot.engine.bytecode.api.BytecodeServiceHolder");
        ...
        types.add("org.glowroot.engine.util.IterableWithSelfRemovableEntries$SelfRemovableEntry");
        types.add("org.glowroot.engine.weaving.Advice");
        types.add("org.glowroot.engine.weaving.AdviceGenerator");
        types.add("org.glowroot.engine.weaving.Advice$AdviceOrdering");
        types.add("org.glowroot.engine.weaving.Advice$AdviceParameter");
        types.add("org.glowroot.engine.weaving.Advice$ParameterKind");
        types.add("org.glowroot.engine.weaving.AdviceAdapter");
        types.add("org.glowroot.engine.weaving.AdviceBuilder");
        types.add("org.glowroot.engine.weaving.AdviceBuilder$AdviceConstructionException");
        types.add("org.glowroot.engine.weaving.AdviceMatcher");
        types.add("org.glowroot.engine.weaving.AnalyzedClass");
        types.add("org.glowroot.engine.weaving.AnalyzedMethod");
        types.add("org.glowroot.engine.weaving.AnalyzedWorld");
        types.add("org.glowroot.engine.weaving.AnalyzedWorld$AnalyzedClassAndLoader");
        types.add("org.glowroot.engine.weaving.AnalyzedWorld$ParseContext");
        types.add("org.glowroot.engine.weaving.BootstrapMetaHolders");
        types.add("org.glowroot.engine.weaving.BootstrapMetaHolders$ClassMetaHolder");
        types.add("org.glowroot.engine.weaving.BootstrapMetaHolders$MethodMetaHolder");
        types.add("org.glowroot.engine.weaving.ClassAnalyzer");
        types.add("org.glowroot.engine.weaving.ClassAnalyzer$AnalyzedMethodKey");
        types.add("org.glowroot.engine.weaving.ClassAnalyzer$BridgeMethodClassVisitor");
        types.add("org.glowroot.engine.weaving.ClassAnalyzer$BridgeMethodClassVisitor"
                + "$BridgeMethodVisitor");
        types.add("org.glowroot.engine.weaving.ClassAnalyzer$MatchedMixinTypes");
        types.add("org.glowroot.engine.weaving.ClassAnalyzer$NonAbstractMethodClassVisitor");
        types.add("org.glowroot.engine.weaving.ClassInfoImpl");
        types.add("org.glowroot.engine.weaving.ClassLoaders");
        types.add("org.glowroot.engine.weaving.ClassLoaders$LazyDefinedClass");
        types.add("org.glowroot.engine.weaving.ClassNames");
        types.add("org.glowroot.engine.weaving.FrameDeduppingMethodVisitor");
        types.add("org.glowroot.engine.weaving.MethodInfoImpl");
        types.add("org.glowroot.engine.weaving.Weaver$ActiveWeaving");
        types.add("org.glowroot.engine.weaving.Weaver$ClassLoaderHackClassVisitor");
        types.add("org.glowroot.engine.weaving.Weaver$ClassLoaderHackMethodVisitor");
        types.add("org.glowroot.engine.weaving.Weaver$JBossUrlHackClassVisitor");
        types.add("org.glowroot.engine.weaving.Weaver$JBossUrlHackMethodVisitor");
        types.add("org.glowroot.engine.weaving.ImmutableAdvice");
        types.add("org.glowroot.engine.weaving.ImmutableAdvice$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableAdvice$InitShim");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedClassAndLoader");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedClassAndLoader$Builder");
        types.add("org.glowroot.engine.weaving.ImmutablePointcutClass");
        types.add("org.glowroot.engine.weaving.ImmutablePointcutClass$Builder");
        types.add("org.glowroot.engine.weaving.ImmutablePointcutMethod");
        types.add("org.glowroot.engine.weaving.ImmutablePointcutMethod$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableAdviceMatcher");
        types.add("org.glowroot.engine.weaving.ImmutableAdviceMatcher$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableAdviceParameter");
        types.add("org.glowroot.engine.weaving.ImmutableAdviceParameter$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedClass");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedClass$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedMethod");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedMethod$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedMethodKey");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedMethodKey$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableCatchHandler");
        types.add("org.glowroot.engine.weaving.ImmutableCatchHandler$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableLazyDefinedClass");
        types.add("org.glowroot.engine.weaving.ImmutableLazyDefinedClass$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableMatchedMixinTypes");
        types.add("org.glowroot.engine.weaving.ImmutableMatchedMixinTypes$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableMethodMetaGroup");
        types.add("org.glowroot.engine.weaving.ImmutableMethodMetaGroup$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableParseContext");
        types.add("org.glowroot.engine.weaving.ImmutableParseContext$Builder");
        types.add("org.glowroot.engine.weaving.ImmutablePublicFinalMethod");
        types.add("org.glowroot.engine.weaving.ImmutablePublicFinalMethod$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableThinClass");
        types.add("org.glowroot.engine.weaving.ImmutableThinClass$Builder");
        types.add("org.glowroot.engine.weaving.ImmutableThinMethod");
        types.add("org.glowroot.engine.weaving.ImmutableThinMethod$Builder");
        types.add("org.glowroot.engine.weaving.InstrumentationSeekerClassVisitor");
        types.add("org.glowroot.engine.weaving.InstrumentationSeekerClassVisitor"
        ...
        types.add("org.glowroot.engine.weaving.JSRInlinerClassVisitor");
        types.add("org.glowroot.engine.weaving.MaybePatterns");
        types.add("org.glowroot.engine.weaving.MixinType");
        types.add("org.glowroot.engine.weaving.InstrumentationClassRenamer");
        types.add("org.glowroot.engine.weaving.InstrumentationClassRenamer"
                + "$InstrumentationClassRemapper");
        types.add("org.glowroot.engine.weaving.InstrumentationDetail$PointcutClass");
        types.add("org.glowroot.engine.weaving.InstrumentationDetail$PointcutMethod");
        types.add("org.glowroot.engine.weaving.InstrumentationDetailBuilder");
        types.add("org.glowroot.engine.weaving.InstrumentationDetailBuilder$MemberClassVisitor");
        types.add("org.glowroot.engine.weaving.InstrumentationDetailBuilder$MixinMethodVisitor");
        types.add("org.glowroot.engine.weaving.InstrumentationDetailBuilder$PointcutMethodVisitor");
        types.add("org.glowroot.engine.weaving.InstrumentationDetailBuilder"
        ...
        types.add("org.glowroot.engine.weaving.PointcutClassVisitor");
        types.add("org.glowroot.engine.weaving.PointcutClassVisitor$PointcutAnnotationVisitor");
        types.add("org.glowroot.engine.weaving.PointcutClassVisitor$PointcutMethodVisitor");
        types.add("org.glowroot.engine.weaving.PreloadSomeSuperTypesCache");
        types.add("org.glowroot.engine.weaving.PreloadSomeSuperTypesCache$CacheValue");
        types.add("org.glowroot.engine.weaving.PublicFinalMethod");
        types.add("org.glowroot.engine.weaving.ShimType");
        types.add("org.glowroot.engine.weaving.ThinClassVisitor");
        types.add("org.glowroot.engine.weaving.ThinClassVisitor$AnnotationCaptureMethodVisitor");
        types.add("org.glowroot.engine.weaving.ThinClassVisitor$PointcutAnnotationVisitor");
        types.add("org.glowroot.engine.weaving.ThinClassVisitor$RemoteAnnotationVisitor");
        types.add("org.glowroot.engine.weaving.ThinClassVisitor$ValueAnnotationVisitor");
        types.add("org.glowroot.engine.weaving.ThinClassVisitor$ThinClass");
        types.add("org.glowroot.engine.weaving.ThinClassVisitor$ThinMethod");
        types.add("org.glowroot.engine.weaving.Weaver");
        types.add("org.glowroot.engine.weaving.WeavingClassFileTransformer");
        types.add("org.glowroot.engine.weaving.WeavingClassVisitor");
        types.add("org.glowroot.engine.weaving.WeavingClassVisitor$InitMixins");
        types.add("org.glowroot.engine.weaving.WeavingClassVisitor$MethodMetaGroup");
        types.add("org.glowroot.engine.weaving.WeavingMethodVisitor");
        types.add("org.glowroot.engine.weaving.WeavingMethodVisitor$CatchHandler");
        ...
        types.add("org.glowroot.instrumentation.api.weaving.BindClassMeta");
        types.add("org.glowroot.instrumentation.api.weaving.BindMethodMeta");
        types.add("org.glowroot.instrumentation.api.weaving.BindMethodName");
        types.add("org.glowroot.instrumentation.api.weaving.BindOptionalReturn");
        types.add("org.glowroot.instrumentation.api.weaving.BindParameter");
        types.add("org.glowroot.instrumentation.api.weaving.BindParameterArray");
        types.add("org.glowroot.instrumentation.api.weaving.BindReceiver");
        types.add("org.glowroot.instrumentation.api.weaving.BindReturn");
        types.add("org.glowroot.instrumentation.api.weaving.BindThrowable");
        types.add("org.glowroot.instrumentation.api.weaving.BindTraveler");
        types.add("org.glowroot.instrumentation.api.weaving.IsEnabled");
        types.add("org.glowroot.instrumentation.api.weaving.MethodModifier");
        types.add("org.glowroot.instrumentation.api.weaving.OnAfter");
        types.add("org.glowroot.instrumentation.api.weaving.OnBefore");
        types.add("org.glowroot.instrumentation.api.weaving.OnReturn");
    ...
    public static List<String> maybeUsedTypes() {
        ...
        types.add("org.glowroot.engine.config.ImmutableAdviceConfig$1");
        types.add("org.glowroot.engine.util.IterableWithSelfRemovableEntries$1");
        types.add("org.glowroot.engine.weaving.Advice$1");
        types.add("org.glowroot.engine.weaving.AdviceBuilder$1");
        types.add("org.glowroot.engine.weaving.AnalyzedClass$1");
        types.add("org.glowroot.engine.weaving.AnalyzedMethod$1");
        types.add("org.glowroot.engine.weaving.AnalyzedMethodKey$1");
        types.add("org.glowroot.engine.weaving.BootstrapMetaHolders$1");
        types.add("org.glowroot.engine.weaving.ClassAnalyzer$1");
        types.add("org.glowroot.engine.weaving.ClassAnalyzer$BridgeMethodClassVisitor$1");
        types.add("org.glowroot.engine.weaving.ImmutablePointcutClass$1");
        types.add("org.glowroot.engine.weaving.ImmutablePointcutMethod$1");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedClass$1");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedClassAndLoader$1");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedMethod$1");
        types.add("org.glowroot.engine.weaving.ImmutableAnalyzedMethodKey$1");
        types.add("org.glowroot.engine.weaving.ImmutableAdvice$1");
        types.add("org.glowroot.engine.weaving.ImmutableAdviceMatcher$1");
        types.add("org.glowroot.engine.weaving.ImmutableAdviceParameter$1");
        types.add("org.glowroot.engine.weaving.ImmutableCatchHandler$1");
        types.add("org.glowroot.engine.weaving.ImmutableLazyDefinedClass$1");
        types.add("org.glowroot.engine.weaving.ImmutableMatchedMixinTypes$1");
        types.add("org.glowroot.engine.weaving.ImmutableMethodMetaGroup$1");
        types.add("org.glowroot.engine.weaving.ImmutableParseContext$1");
        types.add("org.glowroot.engine.weaving.ImmutablePublicFinalMethod$1");
        types.add("org.glowroot.engine.weaving.ImmutableThinClass$1");
        types.add("org.glowroot.engine.weaving.ImmutableThinMethod$1");
        types.add("org.glowroot.engine.weaving.InstrumentationSeekerClassVisitor$1");
        types.add("org.glowroot.engine.weaving.MethodMetaGroup$1");
        types.add("org.glowroot.engine.weaving.ThinClassVisitor$1");
        types.add("org.glowroot.engine.weaving.InstrumentationClassRenamer$1");
        types.add("org.glowroot.engine.weaving.InstrumentationDetailBuilder$1");
        types.add("org.glowroot.engine.weaving.PointcutClassVisitor$1");
        types.add("org.glowroot.engine.weaving.Weaver$1");
        types.add("org.glowroot.engine.weaving.Weaver$2");
        types.add("org.glowroot.engine.weaving.Weaver$FelixOsgiHackClassVisitor$1");
        types.add("org.glowroot.engine.weaving.Weaver$EclipseOsgiHackClassVisitor$1");
        types.add("org.glowroot.engine.weaving.WeavingClassVisitor$1");
        types.add("org.glowroot.engine.weaving.AdviceMatcher$1");
        types.add("org.glowroot.engine.weaving.WeavingMethodVisitor$1");
        types.add("org.glowroot.engine.weaving.PreloadSomeSuperTypesCache$1");
    ...
    private static void preInitializeLinkedHashMapKeySetAndKeySetIterator() {
        ...
        // org.glowroot.engine.weaving.AnalyzedWorld.createAnalyzedClass(AnalyzedWorld.java:320)
        // org.glowroot.engine.weaving.AnalyzedWorld.getOrCreateAnalyzedClass(AnalyzedWorld.java:232)
        // org.glowroot.engine.weaving.AnalyzedWorld.getSuperClasses(AnalyzedWorld.java:189)
        // org.glowroot.engine.weaving.AnalyzedWorld.getAnalyzedHierarchy(AnalyzedWorld.java:139)
        // org.glowroot.engine.weaving.ClassAnalyzer.<init>(ClassAnalyzer.java:108)
        // org.glowroot.engine.weaving.Weaver.weaveUnderTimer(Weaver.java:144)
        // org.glowroot.engine.weaving.Weaver.weave(Weaver.java:95)
        // org.glowroot.engine.weaving.WeavingClassFileTransformer.transformInternal(WeavingClassFileTransformer.java:86)
        // org.glowroot.engine.weaving.WeavingClassFileTransformer.transform(WeavingClassFileTransformer.java:65)
