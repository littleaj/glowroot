...
public class PreInitializeWeavingClassesTest {
    ...
    public void shouldCheckHardcodedListAgainstReality() throws IOException {
        ...
        globalCollector.processMethodFailIfNotFound(
                ReferencedMethod.create("org/glowroot/engine/weaving/AnalyzedWorld", "<init>",
                        "(L" + getGuavaSupplierInternalName()
                                + ";Ljava/util/List;Ljava/util/List;"
                                + "Lorg/glowroot/engine/weaving/PreloadSomeSuperTypesCache;)V"));
        // "call" WeavingClassFileTransformer constructor
        globalCollector.processMethodFailIfNotFound(
                ReferencedMethod.create("org/glowroot/engine/weaving/WeavingClassFileTransformer",
                        "<init>", "(Lorg/glowroot/engine/weaving/Weaver;"
