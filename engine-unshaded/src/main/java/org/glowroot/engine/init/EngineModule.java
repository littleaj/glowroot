...
public class EngineModule {
    ...
    public EngineModule(@Nullable Instrumentation instrumentation, File tmpDir, Ticker ticker,
        ...
        try {
            if (instrumentation != null) {
                ...
                if (JavaVersion.isGreaterThanOrEqualToJava9()) {
                    ...
                    Java9.grantAccess(instrumentation, "org.glowroot.engine.weaving.ClassLoaders",
                    ...
                    Class.forName("org.glowroot.engine.weaving.WeavingClassFileTransformer");
                    // don't remove transformer in case the class is retransformed later
                }
            ...
            // need to initialize glowroot-annotation-api, glowroot-instrumentation-api and
        ...
        // verify initialization of glowroot-annotation-api, glowroot-instrumentation-api and
        // glowroot-engine-bytecode-api services
