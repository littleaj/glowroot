...
public class LogbackIT {
    ...
    public void testLog() throws Exception {
        ...
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.logger.LogbackIT$ShouldLog - def");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.logger.LogbackIT$ShouldLog - efg");
    ...
    public void testLogWithThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.LogbackIT$ShouldLogWithThrowable - def_t");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.LogbackIT$ShouldLogWithThrowable - efg_t");
    ...
    public void testLogWithNullThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.LogbackIT$ShouldLogWithNullThrowable - def_tnull");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.LogbackIT$ShouldLogWithNullThrowable - efg_tnull");
    ...
    public void testLogWithOneParameter() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.LogbackIT$ShouldLogWithOneParameter - def_1 d");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.LogbackIT$ShouldLogWithOneParameter - efg_1 e");
    ...
    public void testLogWithOneParameterAndThrowable() throws Exception {
        ...
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.LogbackIT$ShouldLogWithOneParameterAndThrowable - def_1_t d");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.LogbackIT$ShouldLogWithOneParameterAndThrowable - efg_1_t e");
    ...
    public void testLogWithTwoParameters() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.LogbackIT$ShouldLogWithTwoParameters - def_2 d e");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.LogbackIT$ShouldLogWithTwoParameters - efg_2 e f");
    ...
    public void testLogWithMoreThanTwoParameters() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.LogbackIT$ShouldLogWithMoreThanTwoParameters - def_3 d e f");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.LogbackIT$ShouldLogWithMoreThanTwoParameters - efg_3 e f g");
    ...
    public void testLogWithParametersAndThrowable() throws Exception {
        ...
        assertThat(entry.getMessage()).isEqualTo("log warn:"
                + " o.g.i.l.LogbackIT$ShouldLogWithParametersAndThrowable - def_3_t d e f");
        ...
        assertThat(entry.getMessage()).isEqualTo("log error:"
                + " o.g.i.l.LogbackIT$ShouldLogWithParametersAndThrowable - efg_3_t e f g");
