...
import org.glowroot.engine.util.IterableWithSelfRemovableEntries;
import org.glowroot.engine.util.IterableWithSelfRemovableEntries.SelfRemovableEntry;
...
public class Weaver {
    ...
    private static class ClassLoaderHackMethodVisitor extends AdviceAdapter {
        ...
        protected void onMethodEnter() {
            ...
            visitMethodInsn(INVOKESTATIC, "org/glowroot/engine/bytecode/api/Bytecode",
