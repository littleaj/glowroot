...
public class AsyncRestControllerIT {
    ...
    private void shouldCaptureCallableAsyncController(String contextPath,
        ...
        assertThat(entry.getMessage()).isEqualTo("spring controller: org.glowroot.instrumentation"
        ...
        if (i.hasNext()) {
            ...
            // org.glowroot.instrumentation.spring.AsyncControllerIT$CallableAsyncController$1.call()
            ...
            // see similar issue in org.glowroot.instrumentation.servlet.AsyncServletIT
    ...
    private void shouldCaptureDeferredResultAsyncController(String contextPath,
        ...
        if (i.hasNext()) {
            ...
            // see similar issue in org.glowroot.instrumentation.spring.AsyncControllerIT
