...
public class AxisClientIT {
    ...
    public static class ExecuteSoapRequest implements AppUnderTest, TransactionMarker {
        ...
        public void transactionMarker() throws Exception {
            ...
            call.setPortTypeName(
                    new QName("http://httpclient.instrumentation.glowroot.org/", "HelloWorld"));
            call.setOperationName(
                    new QName("http://httpclient.instrumentation.glowroot.org/", "hello"));
    ...
    @WebService(
            endpointInterface = "org.glowroot.instrumentation.httpclient.AxisClientIT$HelloWorld")
