...
import org.glowroot.instrumentation.api.weaving.BindClassMeta;
import org.glowroot.instrumentation.api.weaving.BindMethodMeta;
import org.glowroot.instrumentation.api.weaving.BindMethodName;
import org.glowroot.instrumentation.api.weaving.BindOptionalReturn;
import org.glowroot.instrumentation.api.weaving.BindParameter;
import org.glowroot.instrumentation.api.weaving.BindParameterArray;
...
public class SomeInstrumentation {
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.Misc"
            + "|org.glowroot.engine.weaving.targets.DefaultMethodMisc"
            + "|org.glowroot.engine.weaving.targets.DefaultMethodMisc2",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.SuperBasicMisc",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.GenericMisc", methodName = "*",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.BasicMisc", methodName = "<init>",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.BasicMisc",
            methodName = "withInnerArg",
            methodParameterTypes = {"org.glowroot.engine.weaving.targets.BasicMisc$Inner"})
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.BasicMisc$InnerMisc",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.Misc", methodName = "execute1",
            methodParameterTypes = {})
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.other.ArrayMisc",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.PrimitiveMisc",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.Misc",
            subTypeRestriction = "org.glowroot.engine.weaving.targets.BasicMisc",
            methodName = "execute1", methodParameterTypes = {})
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.Misc",
            subTypeRestriction = "org.glowroot.engine.weaving.targets.SubBasicMisc",
            methodName = "execute1", methodParameterTypes = {})
    ...
    @Pointcut(classAnnotation = "org.glowroot.engine.weaving.SomeInstrumentation$SomeClass",
            methodAnnotation = "org.glowroot.engine.weaving.SomeInstrumentation$SomeMethod",
    ...
    @Pointcut(className = "*",
            superTypeRestriction = "org.glowroot.engine.weaving.targets.SuperBasicMisc",
            methodAnnotation = "org.glowroot.engine.weaving.SomeInstrumentation$SomeMethod",
            methodParameterTypes = {".."}, timerName = "anno")
    ...
    @Pointcut(className = "*",
            superTypeRestriction = "org.glowroot.engine.weaving.targets.SuperBasicMiscButWrong",
            methodAnnotation = "org.glowroot.engine.weaving.SomeInstrumentation$SomeMethod",
            methodParameterTypes = {".."}, timerName = "anno")
    ...
    @Pointcut(className = "*.BasicMisc",
            superTypeRestriction = "org.glowroot.engine.weaving.targets.Misc",
            methodName = "execute1", methodParameterTypes = {})
    ...
    @Shim("org.glowroot.engine.weaving.targets.ShimmedMisc")
    ...
    @Mixin("org.glowroot.engine.weaving.targets.BasicMisc")
    ...
    @Mixin("org.glowroot.engine.weaving.targets.Misc")
    ...
    @Mixin({"org.glowroot.engine.weaving.targets.Misc",
            "org.glowroot.engine.weaving.targets.Misc2"})
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.Misc", methodName = "execute*",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.StaticMisc",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.Mis*", methodName = "execute1",
            methodParameterTypes = {})
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.Misc", methodName = "*",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.targets.Misc3", methodName = "identity",
            methodParameterTypes = {"org.glowroot.engine.weaving.targets.BasicMisc"})
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.GenerateNotPerfectBytecode$Test",
    ...
    @Pointcut(className = "org.glowroot.engine.weaving.GenerateMoreNotPerfectBytecode$Test"
            + "|org.glowroot.engine.weaving.GenerateStillMoreNotPerfectBytecode$Test",
