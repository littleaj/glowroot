...
public class IsolatedWeavingClassLoader extends ClassLoader {
    ...
    public static boolean loadWithParentClassLoader(String name) {
        ...
        if (name.equals(Agent.class.getName())
                ...
                || name.equals(org.glowroot.instrumentation.api.util.ImmutableList.class.getName())
                || name.equals(org.glowroot.instrumentation.api.util.ImmutableMap.class.getName())
                || name.equals(org.glowroot.instrumentation.api.util.ImmutableSet.class.getName())
