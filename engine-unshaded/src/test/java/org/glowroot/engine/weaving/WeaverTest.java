...
import org.glowroot.engine.weaving.SomeInstrumentation.AnotherAnnotationBasedAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.AnotherAnnotationBasedAdviceButWrong;
import org.glowroot.engine.weaving.SomeInstrumentation.BasicAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BasicAnnotationBasedAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BasicHighOrderAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BasicMiscAllConstructorAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BasicMiscConstructorAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BasicWithInnerClassAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BasicWithInnerClassArgAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindAutoboxedReturnAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindClassMetaAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindMethodMetaAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindMethodMetaArrayAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindMethodMetaReturnArrayAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindMethodNameAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindMutableParameterAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindMutableParameterWithMoreFramesAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindOptionalPrimitiveReturnAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindOptionalReturnAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindOptionalVoidReturnAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindParameterAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindParameterArrayAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindPrimitiveBooleanTravelerAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindPrimitiveReturnAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindPrimitiveTravelerAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindReceiverAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindReturnAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindThrowableAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BindTravelerAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.BrokenAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.ChangeReturnAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.CircularClassDependencyAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.ClassNamePatternAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.ComplexSuperTypeRestrictionAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.FinalMethodAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.GenericMiscAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.HackedConstructorBytecodeAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.HackedConstructorBytecodeJumpingAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.HasString;
import org.glowroot.engine.weaving.SomeInstrumentation.HasStringClassMixin;
import org.glowroot.engine.weaving.SomeInstrumentation.HasStringInterfaceMixin;
import org.glowroot.engine.weaving.SomeInstrumentation.HasStringMultipleMixin;
import org.glowroot.engine.weaving.SomeInstrumentation.InterfaceAppearsTwiceInHierarchyAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.MatchingPublicNonStaticAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.MethodParametersBadDotDotAdvice1;
import org.glowroot.engine.weaving.SomeInstrumentation.MethodParametersDotDotAdvice1;
import org.glowroot.engine.weaving.SomeInstrumentation.MethodParametersDotDotAdvice2;
import org.glowroot.engine.weaving.SomeInstrumentation.MethodParametersDotDotAdvice3;
import org.glowroot.engine.weaving.SomeInstrumentation.MethodReturnCharSequenceAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.MethodReturnStringAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.MethodReturnVoidAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.MoreNotPerfectBytecodeAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.MultipleMethodsAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.NonMatchingMethodReturnAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.NonMatchingMethodReturnAdvice2;
import org.glowroot.engine.weaving.SomeInstrumentation.NonMatchingStaticAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.NotPerfectBytecodeAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.PrimitiveAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.PrimitiveWithAutoboxAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.PrimitiveWithWildcardAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.Shimmy;
import org.glowroot.engine.weaving.SomeInstrumentation.StaticAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.SubTypeRestrictionAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.SubTypeRestrictionWhereMethodNotReImplementedInSubClassAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.SubTypeRestrictionWhereMethodNotReImplementedInSubSubClassAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.SuperBasicAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.SuperTypeRestrictionAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.SuperTypeRestrictionWhereMethodNotReImplementedInSubClassAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice2;
import org.glowroot.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice3;
import org.glowroot.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice4;
import org.glowroot.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice5;
import org.glowroot.engine.weaving.SomeInstrumentation.TestBytecodeWithStackFramesAdvice6;
import org.glowroot.engine.weaving.SomeInstrumentation.TestClassMeta;
import org.glowroot.engine.weaving.SomeInstrumentation.TestMethodMeta;
import org.glowroot.engine.weaving.SomeInstrumentation.TestTroublesomeBytecodeAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.ThrowInOnBeforeAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.ThrowableToStringAdvice;
import org.glowroot.engine.weaving.SomeInstrumentation.WildMethodAdvice;
import org.glowroot.engine.weaving.SomeInstrumentationThreadLocals.IntegerThreadLocal;
import org.glowroot.engine.weaving.other.ArrayMisc;
import org.glowroot.engine.weaving.targets.AbstractMisc.ExtendsAbstractMisc;
import org.glowroot.engine.weaving.targets.AbstractNotMisc.ExtendsAbstractNotMisc;
import org.glowroot.engine.weaving.targets.AbstractNotMiscWithFinal.ExtendsAbstractNotMiscWithFinal;
import org.glowroot.engine.weaving.targets.AccessibilityMisc;
import org.glowroot.engine.weaving.targets.BasicMisc;
import org.glowroot.engine.weaving.targets.BytecodeWithStackFramesMisc;
import org.glowroot.engine.weaving.targets.DuplicateStackFramesMisc;
import org.glowroot.engine.weaving.targets.ExtendsPackagePrivateMisc;
import org.glowroot.engine.weaving.targets.GenericAbstractMiscImpl;
import org.glowroot.engine.weaving.targets.GenericMisc;
import org.glowroot.engine.weaving.targets.GenericMiscImpl;
import org.glowroot.engine.weaving.targets.InnerTryCatchMisc;
import org.glowroot.engine.weaving.targets.Misc;
import org.glowroot.engine.weaving.targets.Misc2;
import org.glowroot.engine.weaving.targets.NativeMisc;
import org.glowroot.engine.weaving.targets.NestingMisc;
import org.glowroot.engine.weaving.targets.OnlyThrowingMisc;
import org.glowroot.engine.weaving.targets.PrimitiveMisc;
import org.glowroot.engine.weaving.targets.ShimmedMisc;
import org.glowroot.engine.weaving.targets.StaticMisc;
import org.glowroot.engine.weaving.targets.StaticSubbedMisc;
import org.glowroot.engine.weaving.targets.SubBasicMisc;
import org.glowroot.engine.weaving.targets.SubException;
import org.glowroot.engine.weaving.targets.SubMisc;
import org.glowroot.engine.weaving.targets.SuperBasic;
import org.glowroot.engine.weaving.targets.SuperBasicMisc;
import org.glowroot.engine.weaving.targets.ThrowMutatedParamMisc;
import org.glowroot.engine.weaving.targets.ThrowingMisc;
...
public class WeaverTest {
    ...
    public void shouldBindMethodMetaArrays() throws Exception {
        ...
        Class<?> somethingPrivateClass =
                Class.forName("org.glowroot.engine.weaving.other.ArrayMisc$SomethingPrivate");
