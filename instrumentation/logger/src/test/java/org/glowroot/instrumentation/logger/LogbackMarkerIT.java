...
public class LogbackMarkerIT {
    ...
    public void testLog() throws Exception {
        ...
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.LogbackMarkerIT$ShouldLog - def");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.LogbackMarkerIT$ShouldLog - efg");
    ...
    public void testLogWithThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.LogbackMarkerIT$ShouldLogWithThrowable - def_t");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.LogbackMarkerIT$ShouldLogWithThrowable - efg_t");
    ...
    public void testLogWithNullThrowable() throws Exception {
        ...
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.LogbackMarkerIT$ShouldLogWithNullThrowable - def_tnull");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.LogbackMarkerIT$ShouldLogWithNullThrowable - efg_tnull");
    ...
    public void testLogWithOneParameter() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.LogbackMarkerIT$ShouldLogWithOneParameter - def_1 d");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.LogbackMarkerIT$ShouldLogWithOneParameter - efg_1 e");
    ...
    public void testLogWithOneParameterAndThrowable() throws Exception {
        ...
        assertThat(entry.getMessage()).isEqualTo("log warn:"
                + " o.g.i.l.LogbackMarkerIT$ShouldLogWithOneParameterAndThrowable - def_1_t d");
        ...
        assertThat(entry.getMessage()).isEqualTo("log error:"
                + " o.g.i.l.LogbackMarkerIT$ShouldLogWithOneParameterAndThrowable - efg_1_t e");
    ...
    public void testLogWithTwoParameters() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.LogbackMarkerIT$ShouldLogWithTwoParameters - def_2 d e");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.LogbackMarkerIT$ShouldLogWithTwoParameters - efg_2 e f");
    ...
    public void testLogWithMoreThanTwoParameters() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo("log warn:"
                + " o.g.i.l.LogbackMarkerIT$ShouldLogWithMoreThanTwoParameters - def_3 d e f");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo("log error:"
                + " o.g.i.l.LogbackMarkerIT$ShouldLogWithMoreThanTwoParameters - efg_3 e f g");
    ...
    public void testLogWithParametersAndThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo("log warn:"
                + " o.g.i.l.LogbackMarkerIT$ShouldLogWithParametersAndThrowable - def_3_t d e f");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo("log error:"
                + " o.g.i.l.LogbackMarkerIT$ShouldLogWithParametersAndThrowable - efg_3_t e f g");
