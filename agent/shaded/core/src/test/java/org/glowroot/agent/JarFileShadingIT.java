...
public class JarFileShadingIT {
    ...
    public void shouldCheckThatJarIsWellShaded() throws IOException {
        ...
        acceptableEntries.add("org/glowroot/annotation/");
        acceptableEntries.add("org/glowroot/annotation/api/.*");
        acceptableEntries.add("org/glowroot/engine/.*");
        acceptableEntries.add("org/glowroot/instrumentation/");
        acceptableEntries.add("org/glowroot/instrumentation/api/.*");
        acceptableEntries.add("org/glowroot/instrumentation/config/.*");
