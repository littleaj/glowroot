...
public class Log4j1xIT {
    ...
    public void testLog() throws Exception {
        ...
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.logger.Log4j1xIT$ShouldLog - def");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.logger.Log4j1xIT$ShouldLog - efg");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log fatal: o.g.i.logger.Log4j1xIT$ShouldLog - fgh");
    ...
    public void testLogWithThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.Log4j1xIT$ShouldLogWithThrowable - def_");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.Log4j1xIT$ShouldLogWithThrowable - efg_");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log fatal: o.g.i.l.Log4j1xIT$ShouldLogWithThrowable - fgh_");
    ...
    public void testLogWithNullThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.Log4j1xIT$ShouldLogWithNullThrowable - def_");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.Log4j1xIT$ShouldLogWithNullThrowable - efg_");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log fatal: o.g.i.l.Log4j1xIT$ShouldLogWithNullThrowable - fgh_");
    ...
    public void testLogWithPriority() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.Log4j1xIT$ShouldLogWithPriority - def__");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.Log4j1xIT$ShouldLogWithPriority - efg__");

        entry = i.next();
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log fatal: o.g.i.l.Log4j1xIT$ShouldLogWithPriority - fgh__");
    ...
    public void testLogWithPriorityAndThrowable() throws Exception {
        ...
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.Log4j1xIT$ShouldLogWithPriorityAndThrowable - def___");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.Log4j1xIT$ShouldLogWithPriorityAndThrowable - efg___");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log fatal: o.g.i.l.Log4j1xIT$ShouldLogWithPriorityAndThrowable - fgh___");
    ...
    public void testLogWithPriorityAndNullThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.Log4j1xIT$ShouldLogWithPriorityAndNullThrowable - def___null");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.Log4j1xIT$ShouldLogWithPriorityAndNullThrowable - efg___null");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log fatal: o.g.i.l.Log4j1xIT$ShouldLogWithPriorityAndNullThrowable - fgh___null");
    ...
    public void testLocalizedLog() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.Log4j1xIT$ShouldLocalizedLog - def____");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.Log4j1xIT$ShouldLocalizedLog - efg____");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log fatal: o.g.i.l.Log4j1xIT$ShouldLocalizedLog - fgh____");
    ...
    public void testLocalizedLogWithNullThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithNullThrowable - def____null");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithNullThrowable - efg____null");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log fatal: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithNullThrowable - fgh____null");
    ...
    public void testLocalizedLogWithParameters() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithParameters - def____");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithParameters - efg____");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log fatal: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithParameters - fgh____");
    ...
    public void testLocalizedLogWithEmptyParameters() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log warn: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithEmptyParameters - def____");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log error: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithEmptyParameters - efg____");
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage()).isEqualTo(
                "log fatal: o.g.i.l.Log4j1xIT$ShouldLocalizedLogWithEmptyParameters - fgh____");
    ...
    public void testLocalizedLogWithParametersAndNullThrowable() throws Exception {
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log warn: o.g.i.l.Log4j1xIT"
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log error: o.g.i.l.Log4j1xIT"
        ...
        assertThat(entry.getDepth()).isEqualTo(0);
        assertThat(entry.getMessage())
                .isEqualTo("log fatal: o.g.i.l.Log4j1xIT"
