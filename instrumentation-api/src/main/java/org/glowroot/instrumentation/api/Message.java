...
import org.glowroot.instrumentation.api.util.Optional;
 ...
 * 
 * As an extra bonus, detail map can also contain org.glowroot.instrumentation.api.util.Optional
 * values which is useful for Maps that do not allow null values, e.g. Maps created using
 * {@link org.glowroot.instrumentation.api.util.ImmutableMap#copyOf(Map)}
 * 
