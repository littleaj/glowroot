...
test1_excluded_instrumentation_modules="!:glowroot-instrumentation-cassandra"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-elasticsearch"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-hibernate"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-http-client"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-jdbc"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-jms"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-jsp"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-kafka"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-logger"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-play"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-quartz"
test1_excluded_instrumentation_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-redis"

# these instrumentation modules are not excluded in test1:
#   glowroot-instrumentation-ejb
#   glowroot-instrumentation-executor
#   glowroot-instrumentation-grails
#   glowroot-instrumentation-jaxrs
#   glowroot-instrumentation-jsf
#   glowroot-instrumentation-netty
#   glowroot-instrumentation-servlet
#   glowroot-instrumentation-spring
#   glowroot-instrumentation-struts

case "$1" in

      "test1") # excluding :glowroot-instrumentation-all, :glowroot-agent-ui-sandbox and :glowroot-agent
               # since they depend on instrumentation modules which are being excluded
               exclude_modules="$test1_excluded_instrumentation_modules,!:glowroot-instrumentation-all,!:glowroot-agent-ui-sandbox,!:glowroot-agent"
      ...
      "test2") mvn clean install -DargLine="$surefire_jvm_args" \
               ...
               mvn clean install -pl ${test1_excluded_instrumentation_modules//!:/:} \
                                 ...
                                 -Dglowroot.it.harness=$GLOWROOT_HARNESS \
                                 -B
               mvn clean verify -pl :glowroot-instrumentation-jdbc \
                                -DargLine="$surefire_jvm_args" \
                                $test_shaded_opt \
                                -Dglowroot.it.harness=$GLOWROOT_HARNESS \
               ...
               then
                 ...
                 if [[ "$TEST_SHADED" == "true" ]]
                 then
                   mvn clean verify -pl :glowroot-instrumentation-logger \
                                    -DargLine="$surefire_jvm_args" \
     ...
     "deploy") # build other (non-deployed) modules since many are used by deploy :glowroot-agent-it-harness and :glowroot-agent (below)
               ...
               then
                 mvn clean deploy -pl :glowroot-parent,:glowroot-annotation-api,:glowroot-instrumentation-api,:glowroot-agent-it-harness,:glowroot-agent,:glowroot-central \
                                  -Pjavadoc \
                                  -DargLine="$surefire_jvm_args" \
                                  $test_shaded_opt \
                                  $cassandra_java_home_opt \
                 ...
                 mvn clean install -pl :glowroot-parent,:glowroot-annotation-api,:glowroot-instrumentation-api,:glowroot-agent-it-harness,:glowroot-agent,:glowroot-central \
                                   -Pjavadoc \
                                   -DargLine="$surefire_jvm_args" \
                                   $test_shaded_opt \
                                   $cassandra_java_home_opt \
    ...
    "checker") set +e
               ...
               mvn clean compile -pl !build/checker-jdk6,!shared/wire-api,!instrumentation/_all,!agent/benchmarks,!agent/ui-sandbox,!agent/dist \
